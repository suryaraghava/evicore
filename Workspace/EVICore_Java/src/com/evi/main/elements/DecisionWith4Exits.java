...
public class DecisionWith4Exits extends DecisionElementBase implements ElementInterface{
	private static Logger logger = Logger.getLogger(DecisionWith4Exits.class);
	...
	public ExitState[] getExitStates() throws ElementException{
		...
		exitStateArray[4] = new ExitState(IVRConstants.novalue,IVRConstants.novalue,IVRConstants.novalue);
		exitStateArray[5] = new ExitState(IVRConstants.error,IVRConstants.error,IVRConstants.error);
