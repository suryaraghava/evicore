...
public class DecisionWith8Exits extends DecisionElementBase implements ElementInterface{
	...
	public ExitState[] getExitStates() throws ElementException{
		ExitState[] exitStateArray = new ExitState[10];
		...
		exitStateArray[8] = new ExitState(IVRConstants.novalue,IVRConstants.novalue,IVRConstants.novalue);
		exitStateArray[9] = new ExitState(IVRConstants.error,IVRConstants.error,IVRConstants.error);
